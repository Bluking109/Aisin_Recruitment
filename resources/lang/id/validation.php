...
return [
    ...
    */
    'attributes' => [
        ...
        'educations.3.major_id' => 'Jurusan',
        'educations.4.major_id' => 'Jurusan',
        'educations.5.major_id' => 'Jurusan',
        'educations.6.major_id' => 'Jurusan',
        ...
        'expertise' => 'Keahlian',
        'working_motivation' => 'Motivasi bekerja',
        'working_reason' => 'Alasan ingin bekerja',
        'expected_facility' => 'Fasilitas yang diharapkan',
        'join_date' => 'Tanggal mulai bekerja',
        'expected_salary' => 'Gaji yang diharapkan',
        'unfavored_environment_other' => 'Field ini',
        'favored environment other' => 'Field ini',
        'like_people' => 'Tipe orang yang disenangi',
        'dificult_decisions' => 'Field ini',
        'favored_environment_other' => 'Field ini',
        'field_of_works' => 'Bidang pekerjaan',
        'certificate' => 'Ijazah',
        'transcripts' => 'Transkrip nilai',
        'kk' => 'KK',
        'ktp' => 'KTP',
        'npwp' => 'NPWP',
        ...
        'hobby' => 'Hobi',
        'fill_spare_time' => 'Cara mengisi waktu luang',
        'strong_point' => 'Kelebihan',
        'weak_point' => 'Kelemahan',
        'right_eye_type' => 'Field ini',
        'left_eye_type' => 'Field ini',
        'right_eye' => 'Field ini',
        'left_eye' => 'Field ini',
        'aggrement' => 'Persetujuan',
        'in_another_recruitment_process' => 'Field ini',
        'other_recruitments.*.organizer' => 'Penyelenggara',
        'other_recruitments.*.is_astra' => 'Field ini',
        'other_recruitments.*.process' => 'Proses',
        'other_recruitments.*.place' => 'Tempat',
        'other_recruitments.*.date' => 'Tanggal',
        'other_recruitments.*.position' => 'Posisi',
        'other_recruitments.*.status' => 'Status',
        'had_disease' => 'Field ini',
        'diseases.*.name' => 'Nama penyakit',
        'diseases.*.from_date' => 'Tanggal mulai',
        'diseases.*.end_date' => 'Tanggal selesai',
        'diseases.*.note' => 'Catatan',
    ],
];