...
@section('title', 'Job Applications (Accepted)')
@section('pages')
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title">Job Applications (Accepted)</h1>
                    <div class="row mb-3 mt-3 pt-2 pb-2">
                        ...
                        <div class="col-sm-3 col-md-2 mb-2">
                            <input type="text" name="finish_at" id="filter-date" class="form-control datepicker" placeholder="Accepted At" value="{{ request()->query('finish_at') }}">
                        </div>
                        {{-- <div class="col-sm-3 col-md-2 mb-2">
...
<script>
    ...
    let generateQueryStringParam = function() {
        ...
        let status = "{{ App\Models\JobApplication::STATUS_ACCEPTED }}";
