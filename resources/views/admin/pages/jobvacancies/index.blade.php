        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.job-vacancies.create') }}" class="btn btn-primary btn-white-text mb-3 mt-3" id="btn-add">Add</a>
            ...
            columns : [
                ...
                { data : 'created_at', name : 'created_at' },
                {
                    ...
                    render: function(data){
                        let urlUpdate = "{{ url(AIIASetting::getValue('admin_base_route').'/job-vacancies') }}/";
            ...
            swalWithBootstrapButtons.fire({
                ...
                if ( result.value ) {
                    $.ajax({
                        ...
                        url: "{{ url(AIIASetting::getValue('admin_base_route').'/job-vacancies') }}/"+id,
                        type: "delete",
                        dataType: "json",
