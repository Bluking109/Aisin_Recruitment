...
<script>
    $(document).ready(function() {
                ...
                { data : 'created_at', name : 'created_at' },
                {
                    ...
                    render: function(data){
                        return `<div class="text-center">
                                    <button type="button" data-id="${data.id}" data-district='${JSON.stringify(data)}' class="btn btn-outline-primary btn-fw btn-update btn-sm">
        ...
        $('.province-ajax').select2({
            ...
            width: 'resolve',
            ajax: {
                url: "{{ route('admin.provinces.getprovince') }}",
                dataType: "json",
